...
export const SvIntroContent = {
  title: "Om mig",
  text: `Jag är en datoringenjörstudent, inom området mjukvaruteknik och en webbutvecklare. Men jag beskriver mig själv som en entusiastisk elev som älskar sin nyfikenhet. Att känna till andra tekniker, till och med en nypa, är alltid trevligt för mig. Det mesta av min inlärningsväg var i Javascript-världen, speciellt reagera och nod. Men jag hade erfarenhet inom andra områden som utveckling av mobilappar och databaser. Jag försöker lära känna hela systemet bättre och bättre varje dag.`,
};

export const SvSocialContent = {
  title: "Kontakta mig",
  sub: "du hittar mig i dessa sociala medier:",
  secondSub: "Eller så kan du kontakta mig via:",
  resume: "Du kan också få en kopia av mitt CV.",
  resumeBtn: "CV",
};

export const SvTimelineContent = {
...
export const SvUsesthisContent = {
  title: "UsesThis",
  description:
